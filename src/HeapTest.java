...
class HeapTest {
    ...
    void testDeleteMin() throws InterruptedException {
        ...
        assert (heap.getNumOfTrees() == 16) : "number of internal trees isn't as expected";

        heap.deleteMin();

        assert (heap.findMin() != null);
        assert (heap.findMin().getKey() == 1) : "minimal key isn't as expected after deleteMin";
        assert (heap.getNumOfTrees() == 4) : "number of internal trees isn't as expected after deleteMin";
        ...
        for (int tries = 1; tries < 5; tries++) {
            ...
            while (!heap.isEmpty()) {
                ...
                heap.deleteMin();
                assert (heap.getNumOfTrees() == expectedNumOfTrees) : "number of internal trees isn't as expected after deleteMin";
                numOfKeys -= 1;
            }
        }
    ...
    void testMeld() {
        ...
        assert (heap1.getNumOfTrees() == 11) : "incorrect number of trees";
        ...
        assert (heap1.getNumOfTrees() == 8) : "incorrect number of trees";
